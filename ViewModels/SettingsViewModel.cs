...
namespace PomodoroWPF.ViewModels
{
    public class SettingsViewModel : ViewModelBase
    {
        ...
        private string _ambientSoundType;
        ...
        public bool AmbientSoundEnabled { get => _ambientSoundEnabled; set => SetProperty(ref _ambientSoundEnabled, value); }
        public string AmbientSoundType { get => _ambientSoundType; set => SetProperty(ref _ambientSoundType, value); }
        ...
        public SettingsViewModel(AppSettings settings, PersistenceService persistence)
        {
            ...
            _ambientSoundEnabled = settings.AmbientSoundEnabled;
            _ambientSoundType = settings.AmbientSoundType;
        ...
        private void Save()
        {
            ...
            _settings.AmbientSoundEnabled = _ambientSoundEnabled;
            _settings.AmbientSoundType = _ambientSoundType;
